...
public class pauseMenu {
	...
	public pauseMenu(SpriteBatch sbb){
		...
		pause = new Window("Paused", SettingsScreen2.skin);
		pause.setMovable(false);
		//unpause = new TextButton("Unpause", SettingsScreen2.skin);
		pause.add(/*unpause*/ new TextButton("Unpause",SettingsScreen2.skin)); //Add a new text button that unpauses the game.
